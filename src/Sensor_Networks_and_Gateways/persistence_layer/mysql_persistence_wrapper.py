...
class MySQLPersistenceWrapper(ApplicationBase):
    ...
    def get_summary(self) -> List[dict]:
        """Returns all sensors in the database using execute query."""
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Getting summary of all gateways and linked sensors')
    ...
    def get_specific_sensor(self, sensor_name: str) -> List[dict]:
        ...
        results = self._execute_query(
            self.SELECT_SPECIFIC_SENSOR, (sensor_name,))
        return results
    ...
    def get_specific_gateway(self, gateway_name: str) -> List[dict]:
        ...
        results = self._execute_query(
            self.SELECT_SPECIFIC_GATEWAY, (gateway_name,))
        return results
    ...
    def create_sensor(self, sensor_name: str) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Creating sensor with name: "{sensor_name}"')
    ...
    def create_gateway(self, gateway_name: str) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Creating gateway with name: "{gateway_name}"')
    ...
    def add_and_autolink_sensor(self, sensor_name: str, gateway_name: int) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Adding sensor "{sensor_name}" and linking to gateway with ID: {gateway_name}')
    ...
    def unlink_sensor(self, sensor_name: int, gateway_name: int) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Unlinking sensor with ID: {sensor_name} from gateway with ID: {gateway_name}')
    ...
    def link_sensor(self, sensor_name: int, gateway_name: int) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Linking sensor with ID: {sensor_name} to gateway with ID: {gateway_name}')
    ...
    def reset_sensor(self, sensor_name: int) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Resetting sensor with ID: {sensor_name}')
    ...
    def reset_gateway(self, gateway_name: int) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Resetting gateway with ID: {gateway_name}')
    ...
    def update_sensor_name(self, sensor_name: int, new_name: str) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Updating sensor name for ID: {sensor_name} to "{new_name}"')
    ...
    def update_gateway_name(self, gateway_name: int, new_name: str) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Updating gateway name for ID: {gateway_name} to "{new_name}"')
    ...
    def delete_sensor(self, sensor_name: int) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Deleting sensor with ID: {sensor_name}')
    ...
    def delete_gateway(self, gateway_name: int) -> int:
        ...
        self._logger.log_debug(
            f'{inspect.currentframe().f_code.co_name}: Deleting gateway with ID: {gateway_name}')
    ...
    def _execute_query(self, query: str, params: tuple = None) -> list:
        ...
        try:
            self._logger.log_debug(
                f'{inspect.currentframe().f_code.co_name}: Running query: {query}')
    ...
    def _execute_operation(self, query: str, params: tuple = None) -> list:
        ...
        try:
            self._logger.log_debug(
                f'{inspect.currentframe().f_code.co_name}: Executing operation: {query}')
            connection = self._connection_pool.get_connection()
    ...
    def _initialize_database_connection_pool(self, config: dict) -> MySQLConnectionPool:
        ...
        try:
            ...
            self._logger.log_error(
                f'{inspect.currentframe().f_code.co_name}: Check DB cnfg:\n{json.dumps(self.DATABASE)}')
        except Exception as e:
            self._logger.log_error(
                f'{inspect.currentframe().f_code.co_name}:Problem creating connection pool: {e}')
            self._logger.log_error(
                f'{inspect.currentframe().f_code.co_name}:Check DB conf:\n{json.dumps(self.DATABASE)}')
